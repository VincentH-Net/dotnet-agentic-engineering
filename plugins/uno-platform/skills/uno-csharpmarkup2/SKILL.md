...
- A **Uno Platform 6** app project must exist in the working folder. Find the Uno app `.csproj` in the working folder. A valid Uno app project should use the Uno SDK and contain `App.xaml.cs` in or under the project folder.
