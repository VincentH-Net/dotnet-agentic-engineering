...
Build and run app via `uno_app_start` (net10.0-desktop) with `args: ["RUN_BY_AGENT"]`. 
To capture the app's stdout output, you MUST use the `stdoutFile` parameter with a file path, 
